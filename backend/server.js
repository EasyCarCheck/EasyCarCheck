...
- FREE SERVICE : BMW, Audi, Mercedes, Volvo proposent tous un free service valable 10 ans OU 100'000 km (selon la première limite atteinte) depuis la première mise en circulation. VÉRIFIE AUTOMATIQUEMENT : si (2026 - année du véhicule < 10) ET (kilométrage < 100000) → le véhicule est ENCORE sous free service même si le vendeur ne le mentionne pas explicitement. Dans ce cas : main d'oeuvre et pièces couvertes, mais estimer les coûts réels selon le type de véhicule (liquides, pneus, plaquettes NON couverts) :
  * Citadine / compacte sous free service : cout_entretien_annee1 = 250, cout_total_3ans = 750, score_entretien = 9
  * Berline / SUV standard sous free service : cout_entretien_annee1 = 400, cout_total_3ans = 1200, score_entretien = 8
  * Sportive premium (M, AMG, RS, S) sous free service : cout_entretien_annee1 = 800, cout_total_3ans = 2400, score_entretien = 7 (liquides haute performance, pneus sport coûteux non couverts)
  * Ultra-sportive (M3, M5, RS6, C63, A45) sous free service : cout_entretien_annee1 = 1200, cout_total_3ans = 3600, score_entretien = 6 (pneus Michelin Pilot Sport 500-800 CHF/axe, liquides spécifiques) Mentionner dans points_positifs ce texte traduit en ${langues[langue] || 'français'} : FR="Entretien main d'oeuvre et pièces couvert par le constructeur (liquides à la charge du propriétaire)" / DE="Arbeits- und Ersatzteile durch den Hersteller abgedeckt (Betriebsstoffe auf Kosten des Besitzers)" / IT="Manodopera e ricambi coperti dal costruttore (liquidi a carico del proprietario)" / EN="Labour and parts covered by the manufacturer (fluids at owner's expense)"
